...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Ogk4iYJnyyZDl/css
    ...
    >
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__zYOu)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__xIo2V)}
                role={"img"}
              />
            ),
